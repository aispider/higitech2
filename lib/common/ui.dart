...
class Ui {
  ...
  static InputDecoration getInputDecoration({String hintText = '', String errorText, IconData iconData, Widget suffixIcon, Widget suffix}) {
    ...
    return InputDecoration(
      ...
      prefixIcon: iconData != null ? Icon(iconData, color: Colors.orange,).marginOnly(right: 10) : SizedBox(),
      ...
      focusedBorder: OutlineInputBorder(borderSide: new BorderSide(color: Colors.green)),
      enabledBorder: OutlineInputBorder(borderSide: new BorderSide(color: Colors.green)),
